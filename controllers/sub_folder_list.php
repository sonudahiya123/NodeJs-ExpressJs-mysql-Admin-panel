...
<div class="dt-responsive table-responsive ">
     <table id="simpletable" class="table table-striped table-bordered nowrap compact dataTable" role="grid">
       <thead>
																...
																<th width="15%"><input id="selecctall" type="checkbox"><label for="selecctall">&nbsp;Check All</label></th></th>
...
<strong> Total Size Used: <?=getfilesize($size); ?></strong> 
</div>                                         
</div>       
</div>
</div>
 ...
 <div class="modal fade" id="add-new-directory" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content new-directory">
                ...
                <div class="modal-body">
                    <div class="">
                        <form action="<?php echo base_url();?>index.php/cloud/addsubdirectory" name="addsubdirectorypopup" id="addsubdirectorypopup" method="post" class="j-pro" id="j-pro" novalidate style="border:none;" autocomplete="off">
